    ...
    public InfinispanGlobalConfigurer globalConfiguration(JHipsterProperties jHipsterProperties) {
        log.info("Defining Infinispan Global Configuration");
            return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-jhipsterSampleApplication4-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(io.github.jhipster.application.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                ...
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.jhipster.application.domain.PersistentToken.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(io.github.jhipster.application.domain.PersistentToken.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(io.github.jhipster.application.domain.User.class.getName() + ".persistentTokens", new JCache<Object, Object>(
                cacheManager.getCache(io.github.jhipster.application.domain.User.class.getName() + ".persistentTokens").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
